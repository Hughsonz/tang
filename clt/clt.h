...
/**
 * Performs the specified method against the specified URL.
 *
 * If ib is specified, it is serialized and sent as the request body.
 * If ob is specified, the server returned JSON will be output.
 *
 * Returns either a negative errno or the HTTP status code.
 */
int
